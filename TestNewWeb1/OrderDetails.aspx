<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderDetails.aspx.cs" Inherits="TestNewWeb1.OrderDeatils" %>
    ...
    <!-- ***** Product Area Starts ***** -->
        <form runat="server" id="FormBuyTheProduct">
            ...
            <section class="section" id="product">
                <div class="container">
                    <div class="row" id="ItemDiv" runat="server">
                        <div class="col-lg-8">
                        ...
                        <div class="col-lg-4">
                            <div class="right-content">
                                ...
                                <div class="quantity-content">
                                    ...
                                    <div class="right-content">
                                        <div class="quantity buttons_added">
                                            <h5 runat="server" id="NOfOrder">3</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="total">
                                        <h4>Total Price</h4>
                                    <div class="quantity buttons_added">
                                        <h5 runat="server" id="TotalPrice">$500</h5>
                                    </div>
                                </div>
                                ...
                                <div class="quantity-content">
                                    ...
                                    <div class="right-content">
                                        <div class="quantity buttons_added">
                                            <h5 runat="server" id="Buyer">Buyer</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="total">
                                    <h4>Order's Date</h4>
                                    <div class="quantity buttons_added">
                                        <h6 runat="server" id="DateOfOrder">24/3/2025</h6>
                                    </div>
                                </div>    
                                ...
                                <div class="quantity-content">
                                    ...
                                    <div class="right-content">
                                        <div class="quantity buttons_added">
                                            <h6 runat="server" id="OrderStatus">Pending</h6>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row" id="NotFoundDiv" runat="server">
                        <div class="col-lg-12">
                            <h1 style="text-align:center;">Order not found</h1>
                        </div>
                    </div>
                </div>
            </section>
